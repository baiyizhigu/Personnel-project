	...
	<div class="side-menu">
		<div class='side-menu-body'>
			<ul>
				...
				<li class=""><a href="#"><i class="icon ti-crown"></i> <span>管理员</span>
				</a>
					<ul>
						<c:if test="${role == '超级管理员'}">
							<li><a class="" href="admin_A_adm.jsp">添加管理员</a></li>
							<!-- active -->
							<li><a href="admin_UD_adm">修改/删除管理员</a></li>
							<!-- <li><a href="admin_U_adm.jsp">修改管理员</a></li> -->
						</c:if>
						<li><a href="admin_Q_adm">查询管理员</a></li>
					</ul></li>
				<li class=""><a href="#"><i class="icon ti-home"></i> <span>部门管理</span>
				</a>
					<ul>
						<c:if test="${role == '超级管理员'}">
							<li><a class="" href="admin_A_dep.jsp">添加部门</a></li>
							<!-- active -->
							<li><a href="admin_UD_dep">修改/删除部门</a></li>
							<!-- <li><a href="dashboard-three.html">修改部门</a></li> -->
						</c:if>
						<li><a href="admin_Q_dep">查询部门</a></li>
					</ul></li>
				...
				<li><a data-attr="" href="#"> <i class="icon ti-layout"></i>
						<span>职位管理</span>
				</a>
					<ul>
						...
						<c:if test="${role == '超级管理员'}">
							<li><a href="admin_A_pos.jsp">添加职位</a></li>
							<li><a href="admin_UD_pos">修改/删除职位</a></li>
							<!-- <li><a href="layout-dark.html">修改职位</a></li> -->
						</c:if>
						<li><a href="admin_Q_pos">查询职位</a></li>
				...
				<li><a href="#"><i class="icon ti-rocket"></i> <span>公告管理</span>
				</a>
					<ul>
						<c:if test="${role == '超级管理员'}">
							<li><a href="admin_A_not.jsp">添加公告</a></li>
							<li><a href="admin_UD_not">修改/删除公告</a></li>
							<!-- <li><a href="chat.html">修改公告</a></li> -->
						</c:if>
						<li><a href="admin_Q_not">查询公告</a></li>
				...
				<li><a href="#"><i class="icon ti-layers-alt"></i> <span>员工管理</span>
				</a>
					<ul>
						<c:if test="${role == '超级管理员'}">
							<li><a href="admin_AQ_sta">添加员工</a></li>
							<li><a href="admin_UD_sta">修改/删除员工</a></li>
							<!-- <li><a href="buttons.html">修改员工</a></li> -->
						</c:if>
						<li><a href="admin_Q_sta">查询员工</a></li>
				...
				<%-- <li><a href="#"><i class="icon ti-paint-roller"></i> <span>信息管理</span>
				</a>
					<ul>
						<c:if test="${role == '超级管理员'}">
							<li><a href="sweet-alert.html">发送信息</a></li>
							<li><a href="lightbox.html">删除信息</a></li>
						</c:if>
						<li><a href="toast.html">查询信息</a></li>
				...
				<li><a href="#"><i class="icon ti-clipboard"></i> <span>文件管理</span>
				</a>
					<ul>
						<c:if test="${role == '超级管理员'}">
							<li><a href="admin_Up_file.jsp">上传文件</a></li>
							<li><a href="admin_D_file">删除文件</a></li>
						</c:if>
						<li><a href="admin_QD_file">查询下载文件</a></li>
				...
				<li class=""><a href="index.jsp"><div class="col-md-3"></div>
						<i class="icon"></i> <span>返回首页</span> </a></li>
		</div>
	</div>
	<!-- end::side menu -->
</body>
