				...
				<div class="card">
					<div class="card-body">
						...
						<div>
							...
							<form id="admin_Q_dep" action="admin_Q_dep">
								<div class="col-md-3">
							...
							<table class="table m-b-0">
								<thead>
									<tr>
										...
										<th class="text-right">部门描述</th>
									</tr>
								</thead>
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${departmentList}" var="Q_dep">
										<tr>
											<td class="text-left" style="height: 50px;">${Q_dep.id}</td>
											<td class="text-center">${Q_dep.name}</td>
											<td class="text-right">${Q_dep.describer}</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
