				...
				<div class="card">
					<div class="card-body">
						...
						<div>
							...
							<form id="staff_QD_file" action="staff_QD_file">
								<div class="col-md-3">
						...
						<div class="table-responsive">
							<table class="table m-b-0">
								...
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${fileList}" var="QD_file">
										<tr>
											<td class="text-left" style="height: 50px;">${QD_file.id}</td>
											<td class="text-left">${QD_file.title}</td>
											<td class="text-center">${QD_file.file_name}</td>
											<td class="text-right">${QD_file.all_name}</td>
											<td class="text-right">${QD_file.time}</td>
											<td class="text-right">
												<form action="staff_Do_file">
													<input id="pageNo" name="name" type="hidden" value="${QD_file.file_name}">
