...
<body>
	...
	<div class="container-fluid">
		...
		<div class="card">
			<div class="card-body">
				<h3 class="card-title">添加职位</h3>
				<form action="admin_A_pos" enctype="multipart/form-data"
					method="post">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-sm"
								id="colFormLabelSm" name="name" placeholder="请输入职位名称"
								value="${name}">
						</div>
					</div>
					<div style="height: 30px;"></div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-sm"
								id="colFormLabelSm" name="department_id" placeholder="请输入部门编号"
								value="${department_id}">
						</div>
					</div>
					<div style="height: 30px;"></div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-sm"
								id="colFormLabelSm" name="describer" placeholder="请添加描述"
								value="${describer}">
						</div>
					</div>
