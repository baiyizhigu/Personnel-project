	...
	<div class="container-fluid">
		...
		<div class="card">
			<div class="card-body">
				...
				<form action="admin_A_adm" enctype="multipart/form-data"
					method="post">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-sm"
								id="colFormLabelSm" name="name" placeholder="请输入管理员名称" value="${name}">
						</div>
					</div>
					<div style="height: 30px;"></div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-sm"
								id="colFormLabelSm" name="password" placeholder="请输入管理员密码" value="${password}">
						</div>
					</div>
					<div style="height: 30px;"></div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-sm"
								id="colFormLabelSm" name="role" placeholder="请输入普通管理员 / 超级管理员" value="${A_role}">
						</div>
					</div>
					<div style="height: 30px;"></div>
					<div class="form-group row">
