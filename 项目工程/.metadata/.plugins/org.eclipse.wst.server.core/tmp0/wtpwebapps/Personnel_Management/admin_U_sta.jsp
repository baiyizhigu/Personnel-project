		...
		<div class="row">
			<div class="card col-md-12">
				<div class="card-body">
					...
					<form action="admin_U_sta" enctype="multipart/form-data"
						method="post">
						<div class="row">
							<div class="col-md-1"></div>
							<div>
								<figure class=""> <img src="/image/${staff.head}"
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div style="height: 30px;">
									<span>编号：</span>
									<%-- <span style="color: red">${id_message}</span> --%>
								</div>
								<div class="form-group">
									<input class="form-control form-control-lg" type="text"
										name="id" value="${staff.id}"> <input
										class="form-control form-control-lg" type="hidden"
										name="old_id" value="${staff.id}">
								</div>
								<div style="height: 30px;">
									<span>名称：</span>
								</div>
								...
								<div class="form-group">
									<input class="form-control form-control-sm" type="text"
										minlength="18" maxlength="18" name="card"
										value="${staff.card}">
								</div>
							</div>
							<div class="col-md-1"></div>
							<div class="col-md-4">
								...
								<div class="form-group">
									<%-- <input class="form-control form-control-sm" type="text"
										name="position_id" value="${staff.position_id}"> --%>
									<select class="form-control" name="DeptJob" id="DeptJob"></select>
								</div>
								<div class="col-md-1"></div>
							</div>
						</div>
						<div class="row">
							...
							<div>
								...
								<p style="color: red">${id_message}</p>
