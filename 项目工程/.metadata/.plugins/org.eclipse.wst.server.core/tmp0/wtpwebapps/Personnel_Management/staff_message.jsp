				...
				<div class="row chat-app">
								...
								<a href="#"
									...
									<div>
										<figure class="avatar avatar-sm"> <img
											src="assets/media/image/avatar.jpg" class="rounded-circle">
										</figure>
									</div>
									<div>
										<div style="height: 3px;"></div>
										<h6 class="m-0">Sigfried Matysik</h6>
										<!-- <p class="m-0 small">123</p> -->
									</div> <!-- <span class="badge badge-primary badge-pill ml-auto">3</span> -->
								</a>
							</div>
						</div>
					</div>
					<div class="col-lg-9 chat-body">
						<div class="chat-body-header">
							...
							<div>
								<h6 class="m-b-0 m-t-5">Alene Ranyelld</h6>
							...
							<div class="message-items">
								...
								<div class="message-item">
									Lorem ipsum dolor sit amet, consectetur adipisicing.<small
										class="message-item-date text-muted">22.30</small>
								</div>
