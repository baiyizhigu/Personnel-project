		...
		<div class="row">
			<div class="card col-md-12">
				<div class="card-body">
					...
					<form action="admin_U_not" enctype="multipart/form-data"
						method="post">
						<div class="row">
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<input class="form-control form-control-lg" type="text"
										name="id" value="${notice.id}"> <input
										class="form-control form-control-lg" type="hidden"
										name="old_id" value="${notice.id}">
								</div>
								<div style="height: 30px;">
									<span>内容：</span>
								</div>
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<input class="form-control form-control-sm" type="text"
										name="admin_id" value="${notice.admin_id}">
								</div>
							</div>
						</div>
