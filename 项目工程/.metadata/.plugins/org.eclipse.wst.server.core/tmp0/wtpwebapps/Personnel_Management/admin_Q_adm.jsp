	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<h3 class="card-title">管理员查询</h3>
						<!-- 模糊查询的搜索表单 -->
						<!-- 跳转页面的表单 -->
						<div>
							<div class="col-md-3"></div>
							<form id="admin_Q_adm" action="admin_Q_adm">
								<div class="col-md-3">
						...
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${adminList}" var="Q_adm">
										<tr>
											<th scope="row" style="height: 50px;">${Q_adm.id}</th>
											<td>${Q_adm.name}</td>
											<td>${Q_adm.password}</td>
											<th><figure class="avatar avatar-sm"> <img
													src="/image/${Q_adm.head}" class="rounded-circle" style="height: 30px;width: 30px;">
												</figure></th>
											<td>${Q_adm.time}</td>
											<td>${Q_adm.role}</td>
										</tr>
