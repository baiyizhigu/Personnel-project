				...
				<div class="card">
					<div class="card-body">
						<div class="d-md-flex justify-content-between">
							<h3 class="card-title">修改/删除部门</h3>
							<div>
								<div class="">
						...
						<div>
							...
							<form id="admin_UD_dep" action="admin_UD_dep">
								<div class="col-md-3">
						...
						<div class="">
							<table class="table m-b-0">
								...
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${depList}" var="UD_dep">
										<tr>
											<td class="text-left" style="height: 50px;">${UD_dep.id}</td>
											<td class="text-right">${UD_dep.name}</td>
											<td class="text-right">${UD_dep.describer}</td>
											<td class="text-right">
												<div class="row">
													<div class="col-md-9"></div>
													<div style="width: 11px;"></div>
													<div class="col-md-1">
														<form action="admin_QU_dep">
