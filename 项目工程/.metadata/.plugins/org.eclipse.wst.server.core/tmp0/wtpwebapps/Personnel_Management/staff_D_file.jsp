				...
				<div class="card">
					<div class="card-body">
						...
						<div>
							...
							<form id="staff_D_file" action="staff_D_file">
								<div class="col-md-3">
						...
						<div class="table-responsive">
							<table class="table m-b-0">
								<thead>
									<tr>
										<th class="text-left">文件编号</th>
										<th class="text-left">文件标题</th>
										<th class="text-center">文件名</th>
										<th class="text-right">上传人</th>
										<th class="text-right">上传时间</th>
										<th class="text-right">删除</th>
									</tr>
								</thead>
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${personalfileList}" var="D_file">
										<tr>
											<td class="text-left" style="height: 50px;">${D_file.id}</td>
											<td class="text-left">${D_file.title}</td>
											<td class="text-center">${D_file.file_name}</td>
											<td class="text-right">${D_file.all_name}</td>
											<td class="text-right">${D_file.time}</td>
											<td class="text-right">
												<form action="staff_De_file">
													<input id="pageNo" name="id" type="hidden" value="${D_file.id}">
													<button class="btn btn-danger" type="submit" onclick="delFun()">删除</button>
												</form>
											</td>
										</tr>
									</c:forEach>
