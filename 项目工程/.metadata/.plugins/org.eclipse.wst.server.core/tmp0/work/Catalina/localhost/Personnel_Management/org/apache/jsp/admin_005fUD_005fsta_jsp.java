 ...
 * Generated at: 2022-09-27 08:34:21 UTC
...
public final class admin_005fUD_005fsta_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<h3 class=\"card-title\">修改/删除员工</h3>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"m-r-10\"></i> <span></span> <i class=\"m-l-10\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"m-t-15\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<!-- 模糊查询的搜索表单 -->\r\n");
      out.write("\t\t\t\t\t\t<!-- 跳转页面的表单 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<form id=\"admin_UD_sta\" action=\"admin_UD_sta\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-left\">编号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-left\">名称</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-left\">密码</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-center\">身份证</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-left\">性别</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-center\">头像</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-center\">职位</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-center\">部门</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-center\">电话</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-center\">创建时间</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th class=\"text-right\">修改/删除</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- 遍历集合 -->\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /admin_UD_sta.jsp(72,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /admin_UD_sta.jsp(76,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /admin_UD_sta.jsp(201,9) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/admin_UD_sta.jsp(201,9) '${staffList}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${staffList}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /admin_UD_sta.jsp(201,9) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("UD_staff");
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-left\" style=\"height: 50px;\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-left\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.name}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-left\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.password}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.card}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-left\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.sex}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\"><figure class=\"avatar avatar-sm\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<img src=\"/image/");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.head}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\" class=\"rounded-circle\"\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"height: 30px; width: 30px;\"> </figure></td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.pos_name}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.dep_name}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.phone}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.time}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-right\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"row\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\"></div>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div style=\"width: 58px;\"></div>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-1\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form action=\"admin_QU_sta\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input id=\"pageNo\" name=\"id\" type=\"hidden\"\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\">\r\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</form>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div style=\"width: 33px;\"></div>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-1\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form action=\"admin_D_sta\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input id=\"pageNo\" name=\"id\" type=\"hidden\"\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UD_staff.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\">\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-danger\" type=\"submit\"\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"deFun()\">删除</button>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</form>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
