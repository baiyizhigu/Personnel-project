		...
		<div class="row">
			<div class="card col-md-12">
				<div class="card-body">
					...
					<form action="admin_U_adm" enctype="multipart/form-data"
						method="post">
						<div class="row">
							<div class="col-md-1"></div>
							<div>
								<figure class=""> <img src="/image/${now_admin.head}"
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<input class="form-control form-control-lg" type="text"
										name="id" value="${now_admin.id}"> <input
										class="form-control form-control-lg" type="hidden"
										name="old_id" value="${now_admin.id}">
								</div>
								<div style="height: 30px;">
									<span>名称：</span>
								</div>
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<input class="form-control form-control-sm" type="text"
										name="password" value="${now_admin.password}">
								</div>
								<div style="height: 30px;">
									<span>身份：</span>
								</div>
								<div class="form-group">
									<input class="form-control form-control-sm" type="text"
										name="role" value="${now_admin.role}">
								</div>
							</div>
						</div>
						<div class="row">
