		...
		<div class="row">
			<div class="card col-md-12">
				<div class="card-body">
					...
					<form action="admin_U_pos" enctype="multipart/form-data"
						method="post">
						<div class="row">
							<div class="col-md-1"></div>
							<div class="col-md-4">
								<div style="height: 30px;">
									<span>编号：</span> <%-- <span style="color: red">${id_message}</span> --%>
								</div>
								<div class="form-group">
									<input class="form-control form-control-lg" type="text"
										name="id" value="${positions.id}"> <input
										class="form-control form-control-lg" type="hidden"
										name="old_id" value="${positions.id}">
								</div>
								<div style="height: 30px;">
									<span>描述：</span>
								</div>
								<div class="form-group">
									<input class="form-control" type="text" name="describer"
										value="${positions.describer}">
								</div>
							</div>
							<div class="col-md-1"></div>
							<div class="col-md-4">
								...
								<div class="form-group">
									<input class="form-control form-control-sm" type="text"
										name="name" value="${positions.name}">
								</div>
								<div style="height: 30px;">
									<span>所属部门编号：</span>
								</div>
								<div class="form-group">
									<input class="form-control form-control-sm" type="text"
										name="dep_id" value="${positions.department_id}">
								</div>
							</div>
						</div>
