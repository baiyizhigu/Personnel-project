				...
				<div class="card">
					<div class="card-body">
						<div class="d-md-flex justify-content-between">
							<h3 class="card-title">修改/删除公告</h3>
							<div>
								<div class="">
						...
						<div>
							...
							<form id="admin_UD_not" action="admin_UD_not">
								<div class="col-md-3">
						...
						<div class="">
							<table class="table m-b-0">
								...
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${noticeList}" var="UD_not">
										<tr>
											<td class="text-left" style="height: 50px;">${UD_not.id}</td>
											<td class="text-center">${UD_not.title}</td>
											<td class="text-center">${UD_not.content}</td>
											<td class="text-center">${UD_not.name}</td>
											<td class="text-center">${UD_not.time}</td>
											<td class="text-right">
												<div class="row">
													<div class="col-md-7"></div>
													<div style="width: 30px;"></div>
													<div class="col-md-1">
														<form action="admin_QU_not">
							...
							<div>
								...
								<span>共有${pageInfo.total}条记录，共为${pageInfo.pages}页</span>
							</div>
							<!-- js -->
