				...
				<div class="card">
					<div class="card-body">
						<div class="d-md-flex justify-content-between">
							<h3 class="card-title">修改/删除员工</h3>
							<div>
								<div class="">
						...
						<div>
							...
							<form id="admin_UD_sta" action="admin_UD_sta">
								<div class="col-md-3">
							...
							<table class="table m-b-0">
								<thead>
									<tr>
										...
										<th class="text-right">修改/删除</th>
									</tr>
								</thead>
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${staffList}" var="UD_staff">
										<tr>
											<td class="text-left" style="height: 50px;">${UD_staff.id}</td>
											<td class="text-left">${UD_staff.name}</td>
											<td class="text-left">${UD_staff.password}</td>
											<td class="text-center">${UD_staff.card}</td>
											<td class="text-left">${UD_staff.sex}</td>
											<td class="text-center"><figure class="avatar avatar-sm">
												<img src="/image/${UD_staff.head}" class="rounded-circle"
													style="height: 30px; width: 30px;"> </figure></td>
											<td class="text-center">${UD_staff.pos_name}</td>
											<td class="text-center">${UD_staff.dep_name}</td>
											<td class="text-center">${UD_staff.phone}</td>
											<td class="text-center">${UD_staff.time}</td>
											<td class="text-right">
												<div class="row">
													<div class="col-md-4"></div>
													<div style="width: 58px;"></div>
													<div class="col-md-1">
														<form action="admin_QU_sta">
															<input id="pageNo" name="id" type="hidden"
																value="${UD_staff.id}">
													...
													<div class="col-md-1">
														<form action="admin_D_sta">
															<input id="pageNo" name="id" type="hidden"
																value="${UD_staff.id}">
															<button class="btn btn-danger" type="submit"
																onclick="deFun()">删除</button>
														</form>
													</div>
												</div>
											</td>
