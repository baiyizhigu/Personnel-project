	...
	<div class="container-fluid">
		...
		<div class="card">
			<div class="card-body">
				...
				<form action="admin_A_not" enctype="multipart/form-data"
					method="post">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-sm"
								id="colFormLabelSm" name="title" placeholder="请输入标题" value="${title}">
						</div>
					</div>
					<div style="height: 30px;"></div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-sm"
								id="colFormLabelSm" name="content" placeholder="请输入内容" value="${content}">
						</div>
					</div>
					<div style="height: 30px;"></div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control form-control-sm"
								id="colFormLabelSm" name="admin_id" placeholder="请输入编号" value="${str_id}">
						</div>
					</div>
					...
					<div class="row">
						...
						<div>
							<p style="color: red">${str_message}</p>
							<p style="color: red">${title_message}</p>
							<p style="color: green">${suc_message}</p>
							<button type="submit" class="btn btn-primary" onclick="addFun()">确认添加</button>
						</div>
					</div>
				</form>
			</div>
