					...
					<div>
						...
						<ul class="list-group list-group-flush m-b-10">
							<li class="list-group-item d-flex p-l-r-0">
								<div>
									<figure class="avatar avatar-xs m-r-10"> <span
										class="avatar-title bg-success rounded-circle">A</span> </figure>
								</div>
								<div>
									<p class="m-b-0">
										<span class="badge small badge-danger">New</span> New user
										registration.
									</p>
									<ul class="list-inline small">
										<li class="list-inline-item text-muted">8 minute ago</li>
										<li class="list-inline-item"><a href="#">Mark Read</a></li>
							...
							<li class="list-group-item d-flex p-l-r-0">
								<div>
									<figure class="avatar avatar-xs m-r-10"> <span
										class="avatar-title rounded-circle"> <i
					...
					<!-- <div>
						...
						<ul class="list-group list-group-flush m-b-10">
							<li class="list-group-item d-flex p-l-r-0">
								<div>
									<figure class="avatar avatar-xs m-r-10"> <span
										class="avatar-title bg-warning rounded-circle">V</span> </figure>
								</div>
								<div>
				...
				<div class="tab-pane-body">
					<div class="m-b-30">
						...
						<ul class="list-group list-group-flush">
							<li
								class="list-group-item d-flex justify-content-between p-l-r-0">
							...
							<li
								...
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input"
										id="customSwitch3" checked> <label
					...
					<div class="m-b-30">
						...
						<ul class="list-group list-group-flush">
							...
							<li
								...
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input"
										id="customSwitch5" checked> <label
					...
					<div class="m-b-30">
						...
						<ul class="list-group list-group-flush">
							...
							<li
								...
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input"
										id="customSwitch8"> <label
										class="custom-control-label" for="customSwitch8"></label>
								</div>
							</li>
							<li
								class="list-group-item d-flex justify-content-between p-l-r-0">
								...
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input"
										id="customSwitch9" checked> <label
										class="custom-control-label" for="customSwitch9"></label>
								</div>
							</li>
						</ul>
					</div>
	...
	<div class="container-fluid">
		...
		<div
			...
			<div>
				...
				<ol class="breadcrumb">
					...
					<fmt:formatDate value="${now_date}" pattern="yyyy-MM-dd" />
					</li>
				</ol>
				</nav>
			</div>
						...
						<div class="d-flex justify-content-between align-items-center">
							<div>
								...
								<h4 class="m-b-0 font-weight-bold">
									0.32% <small data-toggle="tooltip" title="Than last week"
										class="text-success font-size-11"> 1.2% <i
										class="ti-arrow-up"></i>
									</small>
								</h4>
							</div>
					...
					<div class="card-body">
						<div class="d-flex justify-content-between align-items-center">
							<div>
								<h6>购买量</h6>
								<h4 class="m-b-0 font-weight-bold">
									3,137 <small data-toggle="tooltip" title="Than last week"
										class="text-danger font-size-11"> 0.2% <i
					...
					<div class="card-body">
						<div class="d-flex justify-content-between align-items-center">
							<div>
								<h6>订单总额</h6>
								<h4 class="m-b-0 font-weight-bold">
									￥306.20 <small data-toggle="tooltip" title="Than last week"
										class="text-danger font-size-11"> 2.1% <i
										class="ti-arrow-down"></i>
									</small>
								</h4>
							</div>
					...
					<div class="card-body">
						<div class="d-flex justify-content-between align-items-center">
							<div>
								<h6>订单总量</h6>
								<h4 class="m-b-0 font-weight-bold">
									1,650 <small data-toggle="tooltip" title="Than last week"
										class="text-success font-size-11"> 1.2% <i
										class="ti-arrow-up"></i>
									</small>
								</h4>
							...
							<!-- <div>
								<span class="pie"
									data-peity='{ "fill": ["#3a3f51", "#eeeeee"], "radius": 30 }'>0.52,1.041</span>
							</div> -->
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					<div class="card-body">
						<div class="d-md-flex justify-content-between align-items-start">
							<div>
								<h5 class="card-title">销售报告</h5>
								<h6 class="card-subtitle">过去7个月的销售图</h6>
							</div>
							<!-- <div class="reportrange btn btn-sm btn-light">
								<i class="ti-calendar m-r-10"></i> <span></span> <i
									class="ti-angle-down m-l-10"></i>
							</div> -->
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card">
							...
							<div class="card-body text-center">
								...
								<p class="m-b-0">
									<i class="fa fa-caret-up text-primary m-r-5"></i> 23% 上周增加
								</p>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card">
							<div class="card-header">平均订单额</div>
							<div class="card-body text-center">
								<h2 class="text-success font-weight-bold">￥32.52</h2>
								<p class="m-b-0">
									<i class="fa fa-caret-down text-danger m-r-5"></i> 4 低于上周
								</p>
							</div>
						</div>
					</div>
				...
				<!-- <div class="card">
					<div class="card-header">
						<i class="fa fa-download text-muted m-r-5"></i> Download your
						earnings in CSV format
					</div>
					<div class="card-body">
						<p class="text-muted text-center">Open it in a spreadsheet and
							perform your own calculations, graphing etc. The CSV file
							contains additional details, such as the buyer location.</p>
						<div class="row">
				...
				<div class="">
					<!-- <div class="card-header d-flex justify-content-between">
						...
						<ul class="list-inline">
							<li class="list-inline-item"><a href="#"
								class="js-card-refresh link-1"> <i class="fa fa-refresh"></i>
							</a></li>
							<li class="list-inline-item">
								<div class="dropdown">
									<a href="#" class="link-1" data-toggle="dropdown"
					...
					<div class="card-body">
							...
							<div
								...
								<div class="m-l-15">
									...
									<p class="text-muted m-b-0">Lorem ipsum dolor sit amet,
										consectetur adipisicing elit. Dicta iusto magni modi vel.</p>
								</div>
							</div>
						</div> -->
						<!-- <div class="mb-4">
							...
							<div class="d-flex align-items-center">
								<div class="progress flex-grow-1" style="height: 5px">
									<div class="progress-bar bg-google" role="progressbar"
										style="width: 42%;" aria-valuenow="60" aria-valuemin="0"
						...
						<!-- <div class="mb-4">
							...
							<div class="d-flex align-items-center">
								<div class="progress flex-grow-1" style="height: 5px">
									<div class="progress-bar bg-instagram" role="progressbar"
										style="width: 34%;" aria-valuenow="72" aria-valuemin="0"
										aria-valuemax="100"></div>
								</div>
						...
						<!-- <div class="mb-4">
							...
							<div class="d-flex align-items-center">
								<div class="progress flex-grow-1" style="height: 5px">
									<div class="progress-bar bg-whatsapp" role="progressbar"
						...
						<!-- <div>
							...
							<div class="d-flex align-items-center">
								<div class="progress flex-grow-1" style="height: 5px">
									<div class="progress-bar bg-facebook" role="progressbar"
										style="width: 20%;" aria-valuenow="52" aria-valuemin="0"
										aria-valuemax="100"></div>
								</div>
				...
				<div class="card">
					<div class="card-body">
						<div class="d-flex justify-content-between">
							<div>
								<h5 class="card-title">区域销售</h5>
								<h6 class="card-subtitle">地区总销售额图</h6>
							</div>
							<!-- <div>
								<div class="btn-group">
						...
						<div class="row text-center m-t-20">
							...
							<div class="col-md-4 m-t-20">
								...
								<h6 class="m-b-0">利润</h6>
							</div>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header">产品销售</div>
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-6">
								<h3 class="m-b-10">
									4,324 <small class="text-uppercase font-size-11 m-l-5">总额</small>
								</h3>
								...
								<i class="fa fa-caret-up text-success"></i> 10% 减少
							</div>
							<div class="col-md-6">
								<h3 class="m-b-10">
									2,214 <small class="text-uppercase font-size-11 m-l-5">总库存</small>
								</h3>
								<div class="progress m-b-10" style="height: 5px;">
									<div class="progress-bar" role="progressbar"
										style="width: 25%;" aria-valuenow="25" aria-valuemin="0"
								...
								<i class="fa fa-caret-down text-danger"></i> 14% 增加
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-header d-flex justify-content-between">
						...
						<div class="dropdown">
							<a class="btn btn-outline-light btn-sm" href="#"
								data-toggle="dropdown"> USA <i class="ti-angle-down m-l-5"></i>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<a href="#" class="dropdown-item">USA</a> <a href="#"
									class="dropdown-item">Germany</a> <a href="#"
									class="dropdown-item">France</a> <a href="#"
									class="dropdown-item">Italy</a>
							</div>
						</div>
					</div> -->
					<!-- <div class="card-body">
							...
							<table class="table m-b-0">
								...
								<tbody>
									<tr>
										...
										<td>- $3,023.10</td>
										<td><span class="pie"
											data-peity='{ "fill": ["#5d78ff", "#eeeeee"], "radius": 15 }'>70/100</span>
										</td>
									...
									<tr>
										...
										<td>- $2,780.00</td>
										<td><span class="pie"
											data-peity='{ "fill": ["#5d78ff", "#eeeeee"], "radius": 15 }'>40/100</span>
										</td>
									...
									<tr>
										...
										<td>- $2,780.00</td>
										<td><span class="pie"
											data-peity='{ "fill": ["#5d78ff", "#eeeeee"], "radius": 15 }'>60/100</span>
										</td>
									...
									<tr>
										...
										<td>- $2,780.00</td>
										<td><span class="pie"
											data-peity='{ "fill": ["#5d78ff", "#eeeeee"], "radius": 15 }'>18/100</span>
										</td>
									...
									<tr>
										...
										<td>- $2,780.00</td>
										<td><span class="pie"
											data-peity='{ "fill": ["#5d78ff", "#eeeeee"], "radius": 15 }'>25/100</span>
										</td>
									...
									<tr>
										...
										<td>- $2,780.00</td>
										<td><span class="pie"
											data-peity='{ "fill": ["#5d78ff", "#eeeeee"], "radius": 15 }'>78/100</span>
										</td>
		...
		<!-- <div class="row">
			<div class="col-md-4">
				<div class="card">
					<div class="card-header d-flex justify-content-between">
						New Customers <a href="#" class="js-card-refresh link-1"> <i
					...
					<div class="card-body">
						<ul class="list-group list-group-flush">
							<li class="list-group-item d-flex align-items-center p-l-r-0">
								...
								<span class="avatar-title bg-primary rounded-circle">V</span> </figure>
								<div>
								...
								<div class="dropdown ml-auto">
									<a href="#" data-toggle="dropdown"
										class="btn btn-primary btn-sm" aria-haspopup="true"
										aria-expanded="false"> <i class="fa fa-ellipsis-h"
										aria-hidden="true"></i>
									</a>
									<div class="dropdown-menu dropdown-menu-right">
										<a href="#" class="dropdown-item">View</a> <a href="#"
											class="dropdown-item">Send Message</a> <a href="#"
											class="dropdown-item">Assign</a>
									</div>
								</div>
							</li>
							<li class="list-group-item d-flex align-items-center p-l-r-0">
							...
							<li class="list-group-item d-flex align-items-center p-l-r-0">
								<figure class="avatar avatar-sm avatar-state-success m-r-15">
								<span class="avatar-title bg-primary rounded-circle">AE</span> </figure>
								<div>
							...
							<li class="list-group-item d-flex align-items-center p-l-r-0">
								<figure class="avatar avatar-sm avatar-state-success m-r-15">
								<span class="avatar-title bg-dark rounded-circle">KC</span> </figure>
								<div>
							...
							<a href="#"
								class="list-group-item text-center text-uppercase font-size-11 p-b-0">
								View All </a>
						</ul>
					</div>
				</div>
			...
			<!-- <div class="col-md-4">
				<div class="card">
					<div class="card-header d-flex justify-content-between">
						Users Assigned to Me <a href="#" class="js-card-refresh link-1">
						...
						<ul class="list-group list-group-flush">
							<li class="list-group-item d-flex align-items-center p-l-r-0">
								<figure class="avatar avatar-sm m-r-15"> <span
									class="avatar-title bg-success rounded-circle">E</span> </figure>
								<div>
									<h6 class="m-b-0">Emma Maton</h6>
									<small class="text-muted">Engineer</small>
								</div> <span class="badge badge-danger ml-auto">Denied</span>
							</li>
							<li class="list-group-item d-flex align-items-center p-l-r-0">
								<figure class="avatar avatar-sm m-r-15"> <span
									class="avatar-title bg-danger rounded-circle">K</span> </figure>
								<div>
									<h6 class="m-b-0">Kevin Cherryman</h6>
									<small class="text-muted">Human resources</small>
								</div> <span class="badge badge-success ml-auto">Completed</span>
							</li>
							<li href=""
								class="list-group-item d-flex align-items-center p-l-r-0">
								<figure class="avatar avatar-sm m-r-15"> <span
									class="avatar-title bg-warning rounded-circle">SA</span> </figure>
								<div>
									<h6 class="m-b-0">Sarah Hanvey</h6>
									<small class="text-muted">Real estate agent</small>
								</div> <span class="badge badge-warning ml-auto">Pending</span>
							</li>
							<li href="#"
								class="list-group-item d-flex align-items-center p-l-r-0">
								<figure class="avatar avatar-sm m-r-15"> <span
									class="avatar-title bg-info rounded-circle">T</span> </figure>
								<div>
			...
			<!-- <div class="col-md-4">
				<div class="card">
					<div class="card-header d-flex justify-content-between">
						Daily Task List <a href="#" class="link-1"> <i
							class="fa fa-refresh"></i>
						</a>
					</div> -->
					<!-- <div class="card-body">
						<div
							class="custom-control custom-checkbox-success custom-checkbox todo-item">
							<input type="checkbox" class="custom-control-input"
								id="customCheck1"> <label
								class="custom-control-label d-flex justify-content-between"
								for="customCheck1">Talk to new customers <small
								class="text-muted font-size-11">13 May 2019</small>
							</label>
						</div> -->
						<!-- <div
							...
							<input type="checkbox" class="custom-control-input"
								...
								class="custom-control-label d-flex justify-content-between"
								for="customCheck2">Older users will be deleted from the
								system <small class="text-muted font-size-11">20 Apr
									2019</small>
							</label>
						</div> -->
						<!-- <div
							...
							<input type="checkbox" class="custom-control-input"
								...
								class="custom-control-label d-flex justify-content-between"
								for="customCheck3">Assignment will be completed <small
								class="text-muted font-size-11">13 May 2019</small>
							</label>
						</div> -->
						<!-- <div
							...
							<input type="checkbox" class="custom-control-input"
								...
								class="custom-control-label d-flex justify-content-between"
								for="customCheck4">Customer notes <small
								class="text-muted font-size-11">10 Jan 2018</small>
							</label>
						</div> -->
						<!-- <div
							class="custom-control custom-checkbox-success custom-checkbox todo-item">
							<input type="checkbox" class="custom-control-input"
								...
								class="custom-control-label d-flex justify-content-between"
								for="customCheck5">Clear old log records and backup will
								be taken <small class="text-muted font-size-11">13 May
									2019</small>
							</label>
						</div> -->
						<!-- <div class="custom-control custom-checkbox todo-item">
							<input type="checkbox" class="custom-control-input"
								...
								class="custom-control-label d-flex justify-content-between"
								for="customCheck6">Talk to new customers <small
								class="text-muted font-size-11">27 Feb 2019</small>
							</label>
						</div> -->
						<!-- <div
							class="custom-control custom-checkbox-success custom-checkbox todo-item">
							<input type="checkbox" class="custom-control-input"
								id="customCheck7" checked> <label
								class="custom-control-label d-flex justify-content-between"
								for="customCheck7">Older users will be deleted from the
								system <small class="text-muted font-size-11">13 May
									2019</small>
							</label>
						</div> -->
					</div>
