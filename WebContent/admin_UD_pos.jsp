				...
				<div class="card">
					<div class="card-body">
						<div class="d-md-flex justify-content-between">
							<h3 class="card-title">修改/删除职位</h3>
							<div>
								<div class="">
						...
						<div>
							...
							<form id="admin_UD_pos" action="admin_UD_pos">
								<div class="col-md-3">
						...
						<div class="">
							<table class="table m-b-0">
								...
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${posList}" var="UD_pos">
										<tr>
											<td class="text-left" style="height: 50px;">${UD_pos.id}</td>
											<td class="text-right">${UD_pos.name}</td>
											<td class="text-right">${UD_pos.dep_name}</td>
											<td class="text-right">${UD_pos.describer}</td>
											<td class="text-right">
												<div class="row">
													<div class="col-md-8"></div>
													<div style="width: 40px;"></div>
													<div class="col-md-1">
														<form action="admin_QU_pos">
