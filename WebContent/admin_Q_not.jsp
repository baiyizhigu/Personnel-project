				...
				<div class="card">
					<div class="card-body">
						...
						<!-- 模糊查询的搜索表单 -->
							...
							<form id="admin_Q_not" action="admin_Q_not">
								<div class="col-md-3">
						...
						<div class="table-responsive">
							<table class="table m-b-0">
								<thead>
									<tr>
										<th class="text-left">公告编号</th>
										<th class="text-left">公告标题</th>
										<th class="text-center">公告内容</th>
										<th class="text-right">发布人</th>
										<th class="text-right">发布时间</th>
									</tr>
								</thead>
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${noticeList}" var="Q_not">
										<tr>
											<td class="text-left" style="height: 50px;">${Q_not.id}</td>
											<td class="text-left">${Q_not.title}</td>
											<td class="text-center">${Q_not.content}</td>
											<td class="text-right">${Q_not.name}</td>
											<td class="text-right">${Q_not.time}</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
