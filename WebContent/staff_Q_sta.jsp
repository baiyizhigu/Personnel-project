				...
				<div class="card">
					<div class="card-body">
						...
						<div>
							...
							<form id="staff_Q_sta" action="staff_Q_sta">
								<div class="col-md-3">
						...
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${staffList}" var="Q_sta">
										<tr>
											<th scope="row" style="height: 50px;">${Q_sta.id}</th>
											<td>${Q_sta.name}</td>
											<td>${Q_sta.sex}</td>
											<th><figure class="avatar avatar-sm"> <img
													src="/image/${Q_sta.head}" class="rounded-circle" style="height: 30px;width: 30px;">
												</figure></th>
											<td>${Q_sta.pos_name}</td>
											<td>${Q_sta.dep_name}</td>
											<td>${Q_sta.phone}</td>
											<td>${Q_sta.time}</td>
										</tr>
									</c:forEach>
