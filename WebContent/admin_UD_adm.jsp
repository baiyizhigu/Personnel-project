				...
				<div class="card">
					<div class="card-body">
						<div class="d-md-flex justify-content-between">
							<h3 class="card-title">修改/删除管理员</h3>
							<div>
								<div class="">
						...
						<div>
							...
							<form id="admin_UD_adm" action="admin_UD_adm">
								<div class="col-md-3">
						...
						<div class="">
							<table class="table m-b-0">
								...
								<tbody>
									<!-- 遍历集合 -->
									<c:forEach items="${adminList}" var="UD_admin">
										<tr>
											<td class="text-left" style="height: 50px;">${UD_admin.id}</td>
											<td class="text-center">${UD_admin.name}</td>
											<td class="text-center">${UD_admin.password}</td>
											<td class="text-center"><figure class="avatar avatar-sm">
												<img src="/image/${UD_admin.head}" class="rounded-circle"
													style="height: 30px; width: 30px;"> </figure></td>
											<td class="text-center">${UD_admin.time}</td>
											<td class="text-center">${UD_admin.role}</td>
											<td class="text-right">
												<div class="row">
													<div class="col-md-7"></div>
													<div style="width: 30px;"></div>
													<div class="col-md-1">
														<form action="admin_QU_adm">
